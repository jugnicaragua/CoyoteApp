...
class ExchangeRateAdapter(val imageLoader: ImageLoader) : ListAdapter<ExchangeRate, BankViewHolder>(DIFF_CALLBACK){
    companion object{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = BankViewHolder.create(parent, imageLoader)
